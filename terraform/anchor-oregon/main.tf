# ==============================================================================
# Anchor Oregon VPS - Main Configuration
# ==============================================================================
# Creates a new anchor VPS in Oregon for parallel migration.
# After migration complete, this becomes the primary anchor-vps.
#
# Usage:
